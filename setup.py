...
if operacion == "1.1": # Moles a gramos
    ...
    print(f"La molalidad de la solución es {molalidad_final} ")#imprimir resultados
...
#pedirle al usuario los datos necesarios para calcular la densidad con su incertidumbre 
    ...
    print(f"La molalidad de la solución es {molalidad_final} ±{incertidumbre_medida_7} mol/kg.")#imprimir resultados
